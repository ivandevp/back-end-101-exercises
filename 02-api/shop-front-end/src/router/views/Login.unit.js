...
describe('@views/login', () => {
  ...
  xit('redirects to home after successful login', () => {
    const { vm } = mountLogin()
  ...
  xit('redirects to redirectFrom query, if it exists, after successful login', () => {
    const { vm } = mountLogin()
  ...
  xit('displays an error after failed login', () => {
    const { vm } = mountLogin()
